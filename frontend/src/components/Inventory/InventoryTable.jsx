...
const InventoryTable = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:5000/api/products/categories") // Asegúrate de tener este endpoint
      .then((response) => {
    ...
    axios
      .get("http://localhost:5000/api/products/brands") // Asegúrate de tener este endpoint
      .then((response) => {
    ...
    axios
      .get("http://localhost:5000/api/products/sizeProducts") // Asegúrate de tener este endpoint
      .then((response) => {
  ...
  const handleDelete = (id) => {
    if (window.confirm("¿Estás seguro de que deseas eliminar este producto?")) {
      axios
        .delete(`http://localhost:5000/api/products/products/${id}`)
        .then((response) => {
  ...
  const handleRegisterSaleSubmit = () => {
    ...
    axios
      .post("http://localhost:5000/api/sales/register", saleData)
      .then(() => {
        // Actualizar stock después de registrar la venta
        axios
          .put("http://localhost:5000/api/products/update-stock", {
  ...
  const handleAddProduct = () => {
    ...
    axios
      .post("http://localhost:5000/api/products/products", newProduct)
      .then((response) => {
